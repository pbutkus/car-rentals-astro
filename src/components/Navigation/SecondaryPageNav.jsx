...
export default function NavBarTest({ navLink }) {
  ...
  return (
    <nav
      id="navbar"
      class={`bg-gray-950 fixed sticky-top-0 w-screen z-50 h-auto transition duration-500 shadow-lg`}
    >
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div>
              <ul class="flex space-x-4">
                <li>
                  <a class="p-2 inactive nav-link" href="/">
                    Home
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    class={`p-2 ${
                      navLink === "contacts" ? "active" : "inactive"
                    } nav-link`}
                    href="/contacts"
                  >
                    Contacts
          ...
          <ul class="space-y-1 text-gray-50">
            ...
            <li>
              <a
                ...
                href="/about"
                class={`${
                  navLink === "about" ? "mobile-active" : "mobile-inactive"
            ...
            <li>
              <a
                ...
                href="/fleet"
                class={`${
                  navLink === "fleet" ? "mobile-active" : "mobile-inactive"
                } block rounded-md px-3 py-2 text-base font-medium`}
              >
                Fleet
              </a>
            ...
            <li>
              <a
                ...
                href="/contacts"
                class={`${
                  navLink === "contacts" ? "mobile-active" : "mobile-inactive"
                } block rounded-md px-3 py-2 text-base font-medium`}
              >
                Contacts
              </a>
            ...
            <li>
              <a
                ...
                href="/blog/1"
                class={`${
                  navLink === "blog" ? "mobile-active" : "mobile-inactive"
                } block rounded-md px-3 py-2 text-base font-medium`}
              >
                Blog
              </a>
